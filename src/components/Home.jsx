      ...
      <div className="flex flex-col gap-y-5 items-start">
        <div className="w-full flex flex-row gap-x-4 justify-between items-center">
          <input
            ...
            className={`${pasteId ? "w-[80%]" : "w-[85%]"} text-black bg-white placeholder-gray-500 border border-input rounded-md p-2`}
          />
          <button
        ...
        <div className="w-full flex flex-col items-start relative rounded bg-opacity-10 border border-[rgba(128,121,121,0.3)] backdrop-blur-2xl">
          ...
          <textarea
            ...
            className="w-full p-3 focus-visible:ring-0 text-black bg-white placeholder-gray-500"
